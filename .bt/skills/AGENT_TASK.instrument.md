...
Read the install guide from the local docs: `/Users/abhishekratna/Documents/AOL AI/pmmsherpa/.bt/skills/docs/sdk-install/typescript.md`
...
If the SDK does not print a URL, construct one manually using the URL format documented in `/Users/abhishekratna/Documents/AOL AI/pmmsherpa/.bt/skills/docs/sdk-install/braintrust-url-formats.md`:
