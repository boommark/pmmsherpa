...
interface PerplexityIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string
}

/**
 * Perplexity AI logo icon - uses currentColor to match site theming
 * Based on official Perplexity branding
 */
export function PerplexityIcon({ size = 24, className, ...props }: PerplexityIconProps) {
  return (
    <svg
